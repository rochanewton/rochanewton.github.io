...
- IBM Sterling File Gateway, B2B Integrator, Connect:Direct
- AWS & Microsoft Azure cloud platforms
- Former Amazon Web Services employee
- Trilingual (Portuguese, English, Spanish)
- Current focus: IBM Sterling expertise, applied AI, and AWS Certified Solutions Architect – Associate

## Core Expertise Areas

**Middleware & Managed File Transfer:** IBM Sterling File Gateway, IBM Sterling B2B Integrator, IBM Connect:Direct for UNIX/Windows, IBM NetView FTP

**Systems & Enterprise:** Red Hat Enterprise Linux, Ubuntu, CentOS, Debian, Amazon Linux, Active Directory

**Cloud & Virtualization:** AWS (EC2, RDS, S3, Route 53, VPC, Security Groups, CloudWatch, CloudFront), Microsoft Azure (VMs, Storage Accounts, Backup, NSGs, Bastion), Proxmox VE
...
**Soul Bilíngue — Volunteer English Mentor** (Jan 2025 – Present)

Conducts weekly English practice and mentoring sessions, helping students build communication confidence and improve access to education.
...
- MBA in Project Management — Gran Faculdade (Oct 2024 – Mar 2026)
