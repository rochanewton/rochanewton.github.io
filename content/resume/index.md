...
{{< timelineItem icon="worktree" header="Middleware System Administrator" badge="Dec 2021 – May 2024" subheader="Kyndryl" md="true" >}}
...
{{< timelineItem icon="worktree" header="Senior Data Center Technician" badge="Jul 2018 – Jul 2021" subheader="Amazon Web Services" md="true" >}}
*[aws.amazon.com](https://aws.amazon.com)*

Led a hardware decommissioning team retiring 1,000+ legacy racks across all company units under strict safety and data-security procedures, contributing to the buildout of Amazon's global cloud infrastructure. Delivered data center rollout projects end to end, conducted technical interviews, and built the interview-question bank and new-hire training program used for hiring.
{{< /timelineItem >}}

{{< timelineItem icon="worktree" header="Data Center Technician" badge="Jun 2016 – Jul 2018" subheader="Amazon Web Services" md="true" >}}
*[aws.amazon.com](https://aws.amazon.com)*
...
{{< timelineItem icon="worktree" header="Network Administrator" badge="Jun 2013 – May 2016" subheader="Acrisure Brasil" md="true" >}}
...
{{< timelineItem icon="worktree" header="Senior Support Analyst" badge="Jun 2011 – Jun 2013" subheader="Acrisure Brasil" md="true" >}}
*[acrisure.com.br](https://www.acrisure.com.br)*
...
{{< timelineItem icon="worktree" header="Technical Support Analyst" badge="Nov 2009 – Jun 2011" subheader="Hypera" md="true" >}}
...
- Postgraduate Certificate in Project Management — Gran Faculdade (Oct 2024 – Mar 2026)
- Postgraduate Certificate in Cloud Computing — Centro Universitário Senac (Jan 2018 – Dec 2019)
- Associate Degree in Computer Networks — Centro Universitário UniSant'Anna (Feb 2008 – Dec 2010)
