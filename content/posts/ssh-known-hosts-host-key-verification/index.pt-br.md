...
Este post é um spin-off de [SFTP, FTP, FTPS: O Protocolo Por Trás dos Adapters](/posts/sftp-protocol-fundamentals/) — vale a pena ler primeiro se você quiser o quadro completo de onde a verificação de host key se encaixa no handshake SSH.
