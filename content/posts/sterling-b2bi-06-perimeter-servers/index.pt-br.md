...
Mencionei esse componente na [Parte 1]({{< ref "/posts/sterling-b2bi-01-overview/" >}}) e prometi voltar ao assunto, porque a maioria do material introdutório o ignora completamente — o que é uma pena, já que é o motivo real pelo qual um diagrama de implantação do Sterling tem caixas fora do firewall, para começo de conversa, e é o detalhe que faz toda a história da DMZ fazer sentido depois que você entende em que direção o fio realmente corre. Lado a lado, a suposição e a realidade se parecem assim:
...
O Perimeter Server é a peça do diagrama de topologia da [Parte 1]({{< ref "/posts/sterling-b2bi-01-overview/" >}}) que recebeu uma menção de um parágrafo e nada mais até agora. É a primeira coisa que a conexão de um parceiro toca — antes do [Adapter]({{< ref "/posts/sterling-b2bi-02-adapters-vs-services/" >}}), antes do Business Process, antes de o arquivo sequer chegar a uma [Mailbox]({{< ref "/posts/sterling-b2bi-05-mailboxes-file-gateway/" >}}). Toda peça daquele diagrama original agora genuinamente tem seu próprio post por trás dela.
...
A seguir: **O Map Editor** — a camada de tradução sinalizada lá na [Parte 1]({{< ref "/posts/sterling-b2bi-01-overview/" >}}), e a origem de alguns dos bugs mais complicados que já persegui em produção.
