...
Isso fecha o ciclo da visão geral de componentes da [Parte 1]({{< ref "/posts/sterling-b2bi-01-overview/" >}}): o [Perimeter Server]({{< ref "/posts/sterling-b2bi-06-perimeter-servers/" >}}) e os [Adapters]({{< ref "/posts/sterling-b2bi-02-adapters-vs-services/" >}}) trazem o arquivo para dentro, Business Processes e BPML movem e transformam ele ([Parte 3]({{< ref "/posts/sterling-b2bi-03-business-processes-bpml/" >}})), SFTP é o protocolo que a maioria desses adapters de fato fala ([Parte 4]({{< ref "/posts/sterling-b2bi-07-sftp-protocol-fundamentals/" >}})), e Mailboxes — com o File Gateway como uma forma opcional, de nível mais alto, de geri-las — são onde o arquivo pousa e é retirado. Uma peça do diagrama de topologia da Parte 1 ainda deve seu próprio aprofundamento: o próprio Perimeter Server, a seguir.
